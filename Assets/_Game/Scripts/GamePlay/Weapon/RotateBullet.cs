...
{
    [SerializeField] protected float rotateSpeed = GameConstant.Weapon.DEFAULT_BULLET_ROTATION_SPEED;
    [SerializeField] RotationAxis rotationAxis;
    [SerializeField] protected Transform child;
    Vector3 rotateAxisVector;
    public override void OnInit(AbsCharacter attacker, Vector3 targetPos)
    {
